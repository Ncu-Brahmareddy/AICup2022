...
parser.add_argument("--resize",metavar="r",type=int,help=" Value to resize",default = 1028)
parser.add_argument("--size",metavar="s",type=int,help=" Value to size the Image",default = 512)
